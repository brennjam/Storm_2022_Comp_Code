...
// The robot's subsystems
   ...
   /* private final Joystick rightStick = new Joystick(2);
    private final Joystick leftStick = new Joystick(3); */
    private final XboxController Xbox_Driver = new XboxController(1);
    private final XboxController logitech = new XboxController(0);
...
final JoystickButton lowGoalButton = new JoystickButton(Xbox_Driver, XboxController.Button.kX.value);        
...
final JoystickButton highGoalButton = new JoystickButton(Xbox_Driver, XboxController.Button.kY.value);        
...
final JoystickButton raiseButton = new JoystickButton(logitech, XboxController.Button.kLeftBumper.value);
raiseButton.whileHeld(new ClimbCommand(.85, m_climb1) ,true);
    //SmartDashboard.putData("RaiseButton",new ClimbCommand(.3, m_climb1) );
    
final XboxControllerAxisButton lowerButton = new XboxControllerAxisButton(logitech, XboxController.Axis.kLeftTrigger.value);        
lowerButton.whileHeld(new ClimbCommand(-.85, m_climb1) ,true);
   // SmartDashboard.putData("LowerButton",new ClimbCommand(-.3, m_climb1) );
    
final XboxControllerAxisButton secondCLimbUnwind = new XboxControllerAxisButton(logitech, XboxController.Axis.kRightTrigger.value);        
...
final JoystickButton secondClimbWind = new JoystickButton(logitech, XboxController.Button.kRightBumper.value);        
...
final JoystickButton servodownButton = new JoystickButton(logitech, XboxController.Button.kA.value);        
servodownButton.whenPressed(new ServoSetCommand(0.75, m_servos) ,true);
 //    SmartDashboard.putData("ServodownButton",new ServoSetCommand(0.125, m_servos) );

final JoystickButton servoupButton = new JoystickButton(logitech, XboxController.Button.kB.value);        
servoupButton.whenPressed(new ServoSetCommand(0.875, m_servos) ,true);
...
public XboxController getlogitech() {
        return logitech;
    }
