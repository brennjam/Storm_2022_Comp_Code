...
// The robot's subsystems
    ...
    private final XboxController Driver_Control = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=SUBSYSTEM_DEFAULT_COMMAND
     ...
     m_defaultDrive.setDefaultCommand(new DriveWithJoySticks(Driver_Control::getLeftY, Driver_Control::getRightX, m_defaultDrive) );
/*     m_defaultDrive.setDefaultCommand(new DriveWithJoySticks(Driver_Control::getYChannel, Driver_Control::getXChannel, m_defaultDrive));
    m_climb1.setDefaultCommand(new ClimbCommand(Driver_Control::getLeftTriggerAxis, m_climb1) );
    m_climb2.setDefaultCommand(new SecondClimbCommand(Driver_Control::getRightTriggerAxis, m_climb2) ); */
...
// Create some buttons
final XboxControllerAxisButton reverseFlyWheelButton = new XboxControllerAxisButton(Driver_Control, XboxController.Axis.kLeftTrigger.value);     
//final XboxControllerAxisButton reverseFlyWheelButton = new XboxControllerAxisButton(Driver_Control, 2);     
...
final JoystickButton lowGoalButton = new JoystickButton(Driver_Control, XboxController.Button.kY.value);        
...
final JoystickButton highGoalButton = new JoystickButton(Driver_Control, XboxController.Button.kX.value);        
...
final JoystickButton initialArmDownButton = new JoystickButton(Driver_Control, XboxController.Button.kRightBumper.value);        
...
final JoystickButton initialArmUpButton = new JoystickButton(Driver_Control, XboxController.Button.kLeftBumper.value);        
//final JoystickButton initialArmUpButton = new JoystickButton(Driver_Control, 5);        
...
final XboxControllerAxisButton initialIntakeButton = new XboxControllerAxisButton(Driver_Control, XboxController.Axis.kRightTrigger.value );        
...
final XboxControllerAxisButton secondIntakeIn = new XboxControllerAxisButton(Driver_Control, XboxController.Axis.kRightTrigger.value );
...
final XboxControllerAxisButton seondIntakeOut = new XboxControllerAxisButton(Driver_Control, XboxController.Axis.kLeftTrigger.value );
...
final JoystickButton servodownButton = new JoystickButton(climb_Control, XboxController.Button.kX.value);        
...
final JoystickButton servoupButton = new JoystickButton(climb_Control, XboxController.Button.kY.value);        
